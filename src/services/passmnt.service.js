...
async function getAssmnts(sdid) {
  try {
    const res = await axios.get(`${apiurl}/passmnt/all/${sdid}`, authHeader());
    return res.data;
  } catch (err) {
...
async function getAssmntByID(assid) {
  try {
    const res = await axios.get(`${apiurl}/passmnt/${assid}`, authHeader());
    return res.data;
  } catch (err) {
    throw new Error(err.response.data.message);
  }
...
async function getAssmntByIdWithSubmisstion(assid) {
  try {
    ...
    const res = await axios.get(
      `${apiurl}/passmnt/attach/${assid}/${stuid}`,
      authHeader()
    );
    return res.data;
  } catch (err) {
...
async function addAssmnt(data) {
  try {
    const res = await axios.post(`${apiurl}/passmnt`, data, authHeader());
    return res.data;
  } catch (err) {
    throw new Error(err.response.data.message);
  }
...
async function deleteAssmnt(psid) {
  try {
    const res = await axios.delete(`${apiurl}/passmnt/${psid}`, authHeader());
    return res.data;
  } catch (err) {
    throw new Error(err.response.data.message);
  }
...
async function getSubmissions(assid) {
  try {
    const res = await axios.get(
      `${apiurl}/passmnt/submission/all/${assid}`,
      authHeader()
    );
    return res.data;
  } catch (err) {
